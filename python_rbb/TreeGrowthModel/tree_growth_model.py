...
class TreeModel:
    ...
    def generateInitialPopulation(self):
        # Tree IDs
        self.trees = ['tree_' + str(n) for n in range(1, self.number_individuals + 1)]
    ...
    def treeGrowth(self, effective_areas):
        self.growth_rates = self.growth_rate_opt * (effective_areas - (self.biomass_act ** 2 / self.biomass_max ** (4 / 3)))
        self.treeDeath()
